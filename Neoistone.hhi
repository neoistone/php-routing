...
namespace Neoistone\DataGenerator {
    abstract class RegexBasedAbstract implements \Neoistone\DataGenerator {
...
namespace Neoistone\Dispatcher {
    abstract class RegexBasedAbstract implements \Neoistone\Dispatcher {
...
namespace Neoistone\RouteParser {
    class Std implements \Neoistone\RouteParser {

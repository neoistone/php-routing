...
abstract class DispatcherTest extends TestCase
{
    ...
    {
        $dispatcher = \Neoistone\simpleDispatcher($callback, $this->generateDispatcherOptions());
    ...
    /**
     * @expectedException \Neoistone\BadRouteException
     * @expectedExceptionMessage Cannot use the same placeholder "test" twice
     */
    public function testDuplicateVariableNameError()
    {
        \Neoistone\simpleDispatcher(function (RouteCollector $r) {
